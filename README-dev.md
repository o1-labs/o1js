...
- [Dune](https://github.com/ocaml/dune) (only needed when compiling o1js from
  source)
- [Cargo](https://www.rust-lang.org/learn/get-started) (only needed when
...
You can also use the corresponding [Docker
image](https://hub.docker.com/r/o1labs/mina-local-network) manually:
