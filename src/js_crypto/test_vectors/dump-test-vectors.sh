...
pushd ../../../../crypto/proof-systems/poseidon/export_test_vectors
  cargo run -p export_test_vectors -- b10 kimchi ../../../../snarkyjs/src/js_crypto/test_vectors/testVectors.json
  cargo run -p export_test_vectors -- b10 legacy ../../../../snarkyjs/src/js_crypto/test_vectors/testVectorsLegacy.json
popd
