...
import { circuitArray, AsFieldsExtended } from '../lib/circuit_value.js';
import { HashInput } from '../lib/hash.js';

export { asFieldsAndAux, Layout, AsFieldsExtended };

type CustomTypes = Record<string, AsFieldsExtended<any, any>>;
...
type FoldSpec<T, R> = {
  customTypes: CustomTypes;
  map: (type: AsFieldsExtended<any, any>, value?: T) => R;
