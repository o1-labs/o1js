...
let UInt64 = (() => {
    ...
    return _a = class UInt64 extends _classSuper {
            ...
            toUInt32Clamped() {
                let max = (1n << 32n) - 1n;
                let field = Provable.if(this.greaterThan(_a.from(max)), Field.from(max), this.value);
             ...
             */
            addMod64(y) {
                return new _a(addMod64(this.value, y.value).value);
            }
            /**
            ...
            lessThanOrEqual(y) {
                ...
                return lessThanOrEqualGeneric(this.value, y.value, 1n << 64n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            assertLessThanOrEqual(y, message) {
                ...
                assertLessThanOrEqualGeneric(this.value, y.value, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v, message));
            }
            /**
             *
            ...
            lessThan(y) {
                ...
                return lessThanGeneric(this.value, y.value, 1n << 64n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            assertLessThan(y, message) {
                ...
                assertLessThanGeneric(this.value, y.value, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v, message));
            }
            /**
            ...
            static fromBytes(bytes) {
                ...
                return _a.Unsafe.fromField(bytesToWord(bytes));
            }
            /**
            ...
            static fromBits(bits) {
                ...
                return _a.Unsafe.fromField(Field.fromBits(bits));
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _value_decorators = [prop];
...
let UInt32 = (() => {
    ...
    return _a = class UInt32 extends _classSuper {
             ...
             */
            addMod32(y) {
                return new _a(addMod32(this.value, y.value).value);
            }
            /**
             * Integer division with remainder.
             *
            ...
            divMod(y) {
                ...
                if (x.isConstant() && y_.isConstant()) {
                    ...
                    let r = xn - q * yn;
                    return {
                        quotient: new _a(new Field(q.toString()).value),
                        rest: new _a(new Field(r.toString()).value),
                    };
                }
                y_ = y_.seal();
                let q = Provable.witness(Field, () => new Field(x.toBigInt() / y_.toBigInt()));
            ...
            lessThanOrEqual(y) {
                ...
                return lessThanOrEqualGeneric(this.value, y.value, 1n << 32n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            lessThan(y) {
                ...
                return lessThanGeneric(this.value, y.value, 1n << 32n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
...
let Sign = (() => {
    ...
    return _a = class Sign extends _classSuper {
            ...
            static fromJSON(x) {
                return (x === 'Positive' ? new _a(Field(1)) : new _a(Field(-1)));
            }
            neg() {
...
let Int64 = (() => {
    ...
    return _a = class Int64 extends _classSuper {
            ...
            static from(x) {
                ...
                return _a.fromFieldUnchecked(Field(x));
            }
            fromObject(obj) {
            ...
            static fromField(x) {
                ...
                let xInt = Provable.witness(_a, () => _a.fromFieldUnchecked(x));
             ...
             */
            neg() {
                return Provable.if(this.magnitude.value.equals(0), _a.zero, new _a(this.magnitude, this.sgn.neg()));
            }
            /**
             * Addition with overflow checking.
             */
        ...
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(_classSuper[Symbol.metadata] ?? null) : void 0;
            _magnitude_decorators = [prop];
            _sgn_decorators = [prop];
        ...
        _a.Unsafe = {
            fromObject(obj) {
                return CircuitValue.fromObject.call(_a, obj);
            },
        },
        _a;
})();
