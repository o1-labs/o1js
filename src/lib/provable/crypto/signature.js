...
let PrivateKey = (() => {
    ...
    return _a = class PrivateKey extends _classSuper {
             ...
             */
            static fromBits(bs) {
                return new _a(Scalar.fromBits(bs));
            }
            /**
            ...
            static fromBase58(privateKeyBase58) {
                ...
                return new _a(Scalar.from(scalar));
            }
            /**
...
let PublicKey = (() => {
    ...
    return _a = class PublicKey extends _classSuper {
            ...
            static fromPrivateKey({ s }) {
                return _a.fromGroup(Group.generator.scale(s));
            }
            /**
             ...
             */
            static from(g) {
                return _a.fromObject({ x: Field.from(g.x), isOdd: Bool(g.isOdd) });
            }
            /**
            ...
            static fromBase58(publicKeyBase58) {
                ...
                return _a.from({ x: Field(x), isOdd: Bool(!!isOdd) });
            }
            /**
            ...
            static fromValue({ x, isOdd }) {
                return _a.from({ x: Field.from(x), isOdd: Bool(isOdd) });
            }
            constructor() {
                super(...arguments);
...
let Signature = (() => {
    ...
    return _a = class Signature extends _classSuper {
            ...
            static fromBase58(signatureBase58) {
                ...
                return _a.fromObject({ r: Field(r), s: Scalar.from(s) });
            }
            /**
            ...
            static fromValue({ r, s }) {
                return _a.fromObject({ r: Field.from(r), s: Scalar.from(s) });
            }
            constructor() {
                super(...arguments);
