...
class DynamicArrayBase {
     ...
     */
    forEach(f) {
        zip(this.array, __classPrivateFieldGet(this, _DynamicArrayBase_instances, "m", _DynamicArrayBase_dummyMask).call(this)).forEach(([t, isDummy]) => {
            f(t, isDummy);
        });
    }
    /**
