...
function testHashEquality(
  v1: TypesV1.AccountUpdate,
  v2: AccountUpdate.Authorized
) {
...
const v1AccountUpdate: TypesV1.AccountUpdate = {
  ...
  body: {
    ...
    update: {
      appState: new Array(MAX_ZKAPP_STATE_FIELDS).fill({
        isSome: new Bool(true),
        value: new Field(8),
      }),
    ...
    GenericData,
    {
      ...
      preconditions: {
        network: {
          ...
          blockchainLength: Precondition.InRange.betweenInclusive(
            new UInt32(222),
            new UInt32(333)
          ),
          ...
          stakingEpochData: {
            ...
            epochLength: Precondition.InRange.betweenInclusive(
              new UInt32(7777),
              new UInt32(8888)
            ),
          },
        ...
        account: {
          ...
          nonce: Precondition.InRange.betweenInclusive(
            new UInt32(111111),
            new UInt32(222222)
          ),
      ...
      setState: new GenericStateUpdates(
        new Array(MAX_ZKAPP_STATE_FIELDS).fill(Update.set(new Field(8)))
      ),
...
// encoding tests
{
  ...
  testV2Encoding<AccountUpdate.Authorized>(
  ...
  testV1V2ClassEquivalence<
    ...
    TypesV1.AccountUpdate,
    AccountUpdate.Authorized
  >(V1AccountUpdate, AccountUpdate.Authorized, 0);
  testHashEquality(V1AccountUpdate.empty(), AccountUpdate.Authorized.empty());
  testV1V2ValueEquivalence<
    number,
    TypesV1.AccountUpdate,
    AccountUpdate.Authorized
...
// signature test
{
  ...
  console.log(
    `signature = ${JSON.stringify(v2UpdateSigned.authorization.signature)}`
  );
