...
describe('Rosetta', () => {
  ...
  const rosettaUnsignedTxn: UnsignedTransaction = {
    randomOracleInput:
    ...
    signerInput: {
      ...
      suffix: [
        '0000000000000007FFFFFFFC00000006000000000000000200000000001E8480',
  ...
  const mainnetSignatureHex =
    '6fbce9ccad07aa99dad2ad8d5415ac24c0b6e6d2d264f65232c0337417b6d839d2271979d2d44161b0763add744f0e4572516ff40609fe337b48d579e50c941b';
  ...
  it('verify transaction', () => {
    expect(
      client.verifyRosettaTransaction({
        data: rosettaUnsignedTxn,
        signature: mainnetSignatureHex,
        publicKey: publicKey,
      })
    ).toBeTruthy();
      ...
      signatures: [
        {
          ...
          public_key: {
            hex_bytes: publicKeyToHex(PublicKey.fromBase58(publicKey)),
            curve_type: 'pallas',
          },
          signature_type: 'schnorr_poseidon',
