...
describe('Rosetta', () => {
  ...
  const rosettaUnsignedTxn: UnsignedTransaction = JSON.parse(rosettaUnsignedTxnString);
  ...
  // it('test user command', () => {
  //   expect(unsignedTransactionToUserCommand(rosettaUnsignedTxn)).toBeDefined();
  // });
