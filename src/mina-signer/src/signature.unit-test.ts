...
import { AccountUpdate } from '../../snarkyjs-bindings/mina-transaction/gen/transaction-bigint.js';
import { HashInput } from '../../snarkyjs-bindings/provable/provable-bigint.js';
