...
exports.SparkyPerformanceExtensions = void 0;
 ...
 */
class SparkyPerformanceExtensions {
    name = 'SparkyPerformance';
    version = '1.0.0';
    _isActive = false;
    _config;
    _measurements;
    ...
    async initialize() {
        ...
        try {
            ...
            throw new types_js_1.PerformanceError(`Failed to initialize performance extensions: ${errorMessage}`, 'INIT_FAILED');
        }
    }
    /**
    ...
    createDefaultConfig() {
        return {
            enabled: false,
            categories: Object.values(types_js_1.PerformanceCategory),
...
exports.SparkyPerformanceExtensions = SparkyPerformanceExtensions;
