...
exports.setupGlobalSnarky = exports.isSparkyActive = exports.getCurrentBackendType = exports.resetConstraintFlowStats = exports.getConstraintFlowStats = exports.activateOcamlRouting = exports.activateSparkyRouting = exports.updateGlobalSnarkyRouting = exports.wrapBackendWithDebugging = exports.debugConstraintFlow = void 0;
// ===================================================================
// GLOBAL STATE
// ===================================================================
...
exports.debugConstraintFlow = debugConstraintFlow;
/**
...
exports.wrapBackendWithDebugging = wrapBackendWithDebugging;
// ===================================================================
...
exports.updateGlobalSnarkyRouting = updateGlobalSnarkyRouting;
/**
 * Set up Sparky routing (called when switching TO Sparky)
 *
 * @param sparkyBackend - The Sparky backend object
 */
function activateSparkyRouting(sparkyBackend) {
...
exports.getConstraintFlowStats = getConstraintFlowStats;
/**
 * Reset constraint flow debugging
 */
function resetConstraintFlowStats() {
    constraintCallCount = 0;
    globalThis.constraintFlowStats = { sparky: 0, snarky: 0 };
}
exports.resetConstraintFlowStats = resetConstraintFlowStats;
// ===================================================================
