...
exports.inverse = exports.mod = exports.q = exports.p = exports.Fq = exports.Fp = exports.createField = void 0;
...
function fastInverse(x, p, n, kmax, twoToMinusKmax) {
    ...
    for (; i < 2 * n; i++) {
        ...
        let len = Math.max((0, bigint_helpers_js_1.log2)(u), (0, bigint_helpers_js_1.log2)(v));
    ...
    (0, assert_js_1.assert)(mod(x * s - 1n, p) === 0n, 'mod p');
    return s;
}
...
function randomField(p, sizeInBytes, hiBitMask) {
    ...
    while (true) {
        let bytes = (0, random_js_1.randomBytes)(sizeInBytes);
        bytes[sizeInBytes - 1] &= hiBitMask; // zero highest bit, so we get 255 random bits
        let x = (0, bigint_helpers_js_1.bytesToBigInt)(bytes);
        if (x < p)
            return x;
    }
}
...
function createField(p, constants) {
    ...
    let sizeInBits = (0, bigint_helpers_js_1.log2)(p);
