...
exports.FqBindings = exports.FpBindings = void 0;
/**
 * TS implementation of Pasta_bindings.{Fp, Fq}
 */
const finite_field_js_1 = require("../finite-field.js");
const bigint256_js_1 = require("./bigint256.js");
const base_js_1 = require("../../../lib/ml/base.js");
const util_js_1 = require("./util.js");
const FpBindings = (0, util_js_1.withPrefix)('caml_pasta_fp', createFieldBindings(finite_field_js_1.Fp));
exports.FpBindings = FpBindings;
const FqBindings = (0, util_js_1.withPrefix)('caml_pasta_fq', createFieldBindings(finite_field_js_1.Fq));
exports.FqBindings = FqBindings;
function createFieldBindings(Field) {
    return {
        ...
        is_square([, x]) {
            return (0, base_js_1.MlBool)(Field.isSquare(x));
        },
        sqrt([, x]) {
        ...
        to_string([, x]) {
            return (0, bigint256_js_1.toMlStringAscii)(x.toString());
        },
        of_string(s) {
            return [0, Field.fromBigint(BigInt((0, bigint256_js_1.fromMlString)(s)))];
        },
        print(x) {
        ...
        compare(x, y) {
            return bigint256_js_1.Bigint256Bindings.caml_bigint_256_compare(x, y);
        },
        equal([, x], [, y]) {
            return (0, base_js_1.MlBool)(x === y);
        },
        random() {
        ...
        domain_generator(i) {
            ...
            for (let j = 32; j > i; j--) {
                generator = (0, finite_field_js_1.mod)(generator * generator, Field.modulus);
            }
            return [0, generator];
        },
        to_bytes(x) {
            return bigint256_js_1.Bigint256Bindings.caml_bigint_256_to_bytes(x);
        },
        of_bytes(bytes) {
            // not used in js
