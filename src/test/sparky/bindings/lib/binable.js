...
exports.BinableUint64 = exports.BinableUint32 = exports.BinableInt64 = exports.BinableInt32 = exports.BinableString = exports.stringLengthInBytes = exports.stringFromBytes = exports.stringToBytes = exports.withCheck = exports.withBits = exports.bitsToBytes = exports.bytesToBits = exports.prefixToField = exports.enumWithArgument = exports.record = exports.tuple = exports.withVersionNumber = exports.defineBinable = void 0;
// generic encoding infrastructure
const non_negative_js_1 = require("../crypto/non-negative.js");
const bigint_helpers_js_1 = require("../crypto/bigint-helpers.js");
function defineBinable({ toBytes, readBytes, }) {
    ...
    let readBytes_ = (bytes, offset) => {
        (0, non_negative_js_1.assertNonNegativeInteger)(offset, 'readBytes: offset must be integer >= 0');
...
exports.defineBinable = defineBinable;
...
exports.withVersionNumber = withVersionNumber;
...
exports.enumWithArgument = enumWithArgument;
...
exports.BinableString = BinableString;
...
function BinableInt(bits) {
    ...
    return defineBinable({
        toBytes(n) {
            ...
            if (n >= 0) {
                if (n < 0x80n)
                    return (0, bigint_helpers_js_1.bigIntToBytes)(n, 1);
                if (n < 0x8000n)
                    return [CODE_INT16, ...(0, bigint_helpers_js_1.bigIntToBytes)(n, 2)];
                if (n < 0x80000000)
                    return [CODE_INT32, ...(0, bigint_helpers_js_1.bigIntToBytes)(n, 4)];
                else
                    return [CODE_INT64, ...(0, bigint_helpers_js_1.bigIntToBytes)(n, 8)];
            }
            else {
                let M = 1n << 64n;
                if (n >= -0x80n)
                    return [CODE_NEG_INT8, ...(0, bigint_helpers_js_1.bigIntToBytes)((M + n) & 0xffn, 1)];
                if (n >= -0x8000n)
                    return [CODE_INT16, ...(0, bigint_helpers_js_1.bigIntToBytes)((M + n) & 0xffffn, 2)];
                if (n >= -0x80000000)
                    return [CODE_INT32, ...(0, bigint_helpers_js_1.bigIntToBytes)((M + n) & 0xffffffffn, 4)];
                else
                    return [CODE_INT64, ...(0, bigint_helpers_js_1.bigIntToBytes)(M + n, 8)];
            }
        },
        readBytes(bytes, offset) {
...
function fillUInt(startBytes, nBytes) {
    ...
    let x = (0, bigint_helpers_js_1.bytesToBigInt)(intBytes);
    return x;
}
...
exports.BinableInt64 = BinableInt64;
const BinableInt32 = BinableInt(32);
exports.BinableInt32 = BinableInt32;
const BinableUint64 = BinableUint(64);
exports.BinableUint64 = BinableUint64;
const BinableUint32 = BinableUint(32);
exports.BinableUint32 = BinableUint32;
...
exports.prefixToField = prefixToField;
