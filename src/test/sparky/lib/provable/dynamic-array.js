...
class DynamicArrayBase {
    ...
    setOrDoNothing(i, value) {
        (0, arrays_js_1.zip)(this.array, this.#indexMask(i)).forEach(([t, equalsIJ], i) => {
     ...
     */
    forEach(f) {
        (0, arrays_js_1.zip)(this.array, this.#dummyMask()).forEach(([t, isDummy]) => {
            f(t, isDummy);
        });
    }
    /**
