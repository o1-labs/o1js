...
class Packed {
    ...
    static create(type) {
        ...
        return class Packed_ extends Packed {
            static _innerProvable = provable;
            static _provable = (0, provable_derivers_js_1.mapValue)((0, provable_derivers_js_1.provableFromClass)(Packed_, {
                packed: packedFields,
...
class Hashed {
    ...
    static create(type, hash) {
        ...
        return class Hashed_ extends Hashed {
            static _innerProvable = provable;
            static _provable = (0, provable_derivers_js_1.provableFromClass)(Hashed_, {
