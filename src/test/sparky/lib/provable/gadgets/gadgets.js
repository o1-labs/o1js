...
exports.ForeignFieldSum = exports.Field3 = exports.Gadgets = void 0;
/**
 * Wrapper file for various gadgets, with a namespace and doccomments.
 */
const range_check_js_1 = require("./range-check.js");
const bitwise_js_1 = require("./bitwise.js");
const foreign_field_js_1 = require("./foreign-field.js");
Object.defineProperty(exports, "Field3", { enumerable: true, get: function () { return foreign_field_js_1.Field3; } });
Object.defineProperty(exports, "ForeignFieldSum", { enumerable: true, get: function () { return foreign_field_js_1.Sum; } });
...
const Gadgets = {
     ...
     */
    rangeCheck64(x) {
        return (0, range_check_js_1.rangeCheck64)(x);
    },
    /**
     ...
     */
    rangeCheck32(x) {
        return (0, range_check_js_1.rangeCheck32)(x);
    },
    /**
    ...
    rangeCheckN(n, x, message) {
        return (0, range_check_js_1.rangeCheckN)(n, x, message);
    },
    /**
    ...
    isDefinitelyInRangeN(n, x) {
        return (0, range_check_js_1.isDefinitelyInRangeN)(n, x);
    },
    /*
     ...
     */
    rangeCheck16(x) {
        return (0, range_check_js_1.rangeCheck16)(x);
    },
    /**
     ...
     */
    rangeCheck8(x) {
        return (0, range_check_js_1.rangeCheck8)(x);
    },
    /**
    ...
    rotate64(field, bits, direction = 'left') {
        return (0, bitwise_js_1.rotate64)(field, bits, direction);
    },
    /**
     * A (left and right) rotation operates similarly to the shift operation (`<<` for left and `>>` for right) in JavaScript,
    ...
    rotate32(field, bits, direction = 'left') {
        return (0, bitwise_js_1.rotate32)(field, bits, direction);
    },
    /**
     ...
     */
    xor(a, b, length) {
        return (0, bitwise_js_1.xor)(a, b, length);
    },
    /**
    ...
    not(a, length, checked = false) {
        return (0, bitwise_js_1.not)(a, length, checked);
    },
    /**
    ...
    leftShift64(field, bits) {
        return (0, bitwise_js_1.leftShift64)(field, bits);
    },
    /**
     * Performs a left shift operation on the provided {@link Field} element.
     * This operation is similar to the `<<` shift operation in JavaScript,
    ...
    leftShift32(field, bits) {
        return (0, bitwise_js_1.leftShift32)(field, bits);
    },
    /**
    ...
    rightShift64(field, bits) {
        return (0, bitwise_js_1.rightShift64)(field, bits);
    },
    /**
     ...
     */
    and(a, b, length) {
        return (0, bitwise_js_1.and)(a, b, length);
    },
    /**
     ...
     */
    or(a, b, length) {
        return (0, bitwise_js_1.or)(a, b, length);
    },
    /**
     * Multi-range check.
     *
    ...
    multiRangeCheck(limbs) {
        (0, range_check_js_1.multiRangeCheck)(limbs);
    },
    /**
    ...
    compactMultiRangeCheck(xy, z) {
        return (0, range_check_js_1.compactMultiRangeCheck)(xy, z);
    },
    /**
    ...
    rangeCheck3x12(v0, v1, v2) {
        return (0, lookup_js_1.rangeCheck3x12)(v0, v1, v2);
    },
    /**
    ...
    inTable(id, pair0, pair1, pair2) {
        return (0, lookup_js_1.inTable)(id, pair0, pair1, pair2);
    },
    /**
    ...
    ForeignField: {
         ...
         */
        add(x, y, f) {
            return foreign_field_js_1.ForeignField.add(x, y, f);
        },
        /**
         ...
         */
        equals(x, c, f) {
            return foreign_field_js_1.ForeignField.equals(x, c, f);
        },
        /**
         ...
         */
        sub(x, y, f) {
            return foreign_field_js_1.ForeignField.sub(x, y, f);
        },
        /**
         ...
         */
        neg(x, f) {
            return foreign_field_js_1.ForeignField.negate(x, f);
        },
        /**
         ...
         */
        sum(xs, signs, f) {
            return foreign_field_js_1.ForeignField.sum(xs, signs, f);
        },
        /**
         * @internal
         *
         ...
         */
        mul(x, y, f) {
            return foreign_field_js_1.ForeignField.mul(x, y, f);
        },
        /**
         * @internal
         *
         ...
         */
        inv(x, f) {
            return foreign_field_js_1.ForeignField.inv(x, f);
        },
        /**
         * @internal
         *
         ...
         */
        div(x, y, f) {
            return foreign_field_js_1.ForeignField.div(x, y, f);
        },
        /**
         * @internal
         *
        ...
        assertMul(x, y, z, f, message) {
            return foreign_field_js_1.ForeignField.assertMul(x, y, z, f, message);
        },
        /**
         * @internal
         *
         ...
         */
        Sum(x) {
            return foreign_field_js_1.ForeignField.Sum(x);
        },
        /**
         * @internal
         *
        ...
        assertAlmostReduced(xs, f, { skipMrc = false } = {}) {
            foreign_field_js_1.ForeignField.assertAlmostReduced(xs, f, skipMrc);
        },
        /**
         ...
         */
        assertLessThan(x, f) {
            foreign_field_js_1.ForeignField.assertLessThan(x, f);
        },
        /**
         * Prove that x <= f for any constant f < 2^264, or for another `Field3` f.
         *
        ...
        assertLessThanOrEqual(x, f) {
            foreign_field_js_1.ForeignField.assertLessThanOrEqual(x, f);
        },
        /**
         * Proves that x is equal to y.
         */
        assertEquals(x, y) {
            foreign_field_js_1.ForeignField.assertEquals(x, y);
        },
        /**
         ...
         */
        toCanonical(x, f) {
            return foreign_field_js_1.ForeignField.toCanonical(x, f);
        },
        /**
         ...
         */
        sliceField3: bit_slices_js_1.sliceField3,
    },
    /**
     ...
     */
    Field3: foreign_field_js_1.Field3,
    /**
     ...
     * ```
     */
    divMod32: arithmetic_js_1.divMod32,
    /**
     ...
     * ```
     *    */
    addMod32: arithmetic_js_1.addMod32,
    /**
     ...
     * ```
     */
    divMod64: arithmetic_js_1.divMod64,
    /**
     ...
     * ```
     */
    addMod64: arithmetic_js_1.addMod64,
    /**
     *
     ...
     *
     */
    BLAKE2B: blake2b_js_1.BLAKE2B,
    /**
     * Default limb size constants mostly used in range checks.
     */
    Constants: {
        l2Mask: range_check_js_1.l2Mask,
        l: range_check_js_1.l,
        l2: range_check_js_1.l2,
        l3: range_check_js_1.l3,
        lMask: range_check_js_1.lMask,
    },
};
