...
class Sponge {
    ...
    constructor() {
        ...
        this.#sponge = bindings_js_1.Snarky.poseidon.sponge.create(isChecked);
    }
    absorb(x) {
        bindings_js_1.Snarky.poseidon.sponge.absorb(this.#sponge, x.value);
    }
    squeeze() {
        return (0, wrapped_js_1.Field)(bindings_js_1.Snarky.poseidon.sponge.squeeze(this.#sponge));
    }
}
const Poseidon = {
    hash(input) {
