...
const Hash = {
    ...
    SHA2_256: {
         ...
         */
        hash: gadgets_js_1.Gadgets.SHA256.hash,
    },
    /**
    ...
    SHA2: {
         ...
         */
        hash: gadgets_js_1.Gadgets.SHA2.hash,
    },
    /**
    ...
    SHA3_256: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.nistSha3(256, bytes);
        },
    },
    /**
    ...
    SHA3_384: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.nistSha3(384, bytes);
        },
    },
    /**
    ...
    SHA3_512: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.nistSha3(512, bytes);
        },
    },
    /**
    ...
    Keccak256: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.preNist(256, bytes);
        },
    },
    /**
    ...
    Keccak384: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.preNist(384, bytes);
        },
    },
    /**
    ...
    Keccak512: {
         ...
         */
        hash(bytes) {
            return keccak_js_1.Keccak.preNist(512, bytes);
        },
    },
    BLAKE2B: {
        hash(bytes) {
            return gadgets_js_1.Gadgets.BLAKE2B.hash(bytes);
        },
    },
};
exports.Hash = Hash;
