...
exports.featureFlagsFromGates = exports.featureFlagsToMlOption = exports.FeatureFlags = void 0;
...
exports.featureFlagsFromGates = featureFlagsFromGates;
function featureFlagsToMlOption(flags, withRuntimeTables) {
    ...
    return [
        0,
        base_js_1.MlOption.mapTo(rangeCheck0, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(rangeCheck1, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(foreignFieldAdd, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(foreignFieldMul, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(xor, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(rot, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(lookup, base_js_1.MlBool),
        base_js_1.MlOption.mapTo(runtimeTables || withRuntimeTables, base_js_1.MlBool),
    ];
}
exports.featureFlagsToMlOption = featureFlagsToMlOption;
