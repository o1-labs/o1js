...
function method(target, methodName, descriptor, returnType) {
    ...
    class SelfProof extends proof_js_1.Proof {
        static publicInputType = account_update_js_1.ZkappPublicInput;
        static publicOutputType = zkprogram_js_1.Empty;
...
class SmartContract extends smart_contract_base_js_1.SmartContractBase {
    ...
    static _methods;
    static _methodMetadata; // keyed by method name
    static _provers;
    ...
    static Proof() {
        let Contract = this;
        return class extends proof_js_1.Proof {
            static publicInputType = account_update_js_1.ZkappPublicInput;
            static publicOutputType = zkprogram_js_1.Empty;
            static tag = () => Contract;
        };
