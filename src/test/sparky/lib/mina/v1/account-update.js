...
class AccountUpdate {
    ...
    static signingInfo = (0, provable_derivers_js_1.provable)({
    ...
    static sizeInFields = types_js_1.Types.AccountUpdate.sizeInFields;
    static toFields = types_js_1.Types.AccountUpdate.toFields;
    ...
    static toInput = types_js_1.Types.AccountUpdate.toInput;
    static empty() {
        return AccountUpdate.dummy();
    }
    static check = types_js_1.Types.AccountUpdate.check;
    ...
    static toValue = types_js_1.Types.AccountUpdate.toValue;
 ...
 * ```
 */
class AccountUpdateForest extends merkle_list_js_1.MerkleList.create(AccountUpdateTreeBase, merkleListHash) {
    static provable = (0, provable_derivers_js_1.provableExtends)(AccountUpdateForest, super.provable);
    push(update) {
