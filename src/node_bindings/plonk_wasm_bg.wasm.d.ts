...
export function wasmfpproofevaluations_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function wasmfpproofevaluations_w(a: number): number;
export function wasmfpproofevaluations_coefficients(a: number): number;
...
export function wasmfpproofevaluations_set_coefficients(a: number, b: number): void;
...
export function wasmfqproofevaluations_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number): number;
export function wasmfqproofevaluations_w(a: number): number;
export function wasmfqproofevaluations_coefficients(a: number): number;
...
export function wasmfqproofevaluations_set_coefficients(a: number, b: number): void;
