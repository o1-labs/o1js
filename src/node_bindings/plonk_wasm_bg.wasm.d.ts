...
export function caml_pasta_fp_plonk_index_create(a: number, b: number, c: number, d: number): void;
...
export function caml_pasta_fq_plonk_index_create(a: number, b: number, c: number, d: number): void;
...
export function wasmfqplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function wasmfpplonkverifierindex_new(a: number, b: number, c: number, d: number, e: number, f: number): number;
