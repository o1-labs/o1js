 ...
 */
export async function initSparkyWasm() {
    ...
    initPromise = (async () => {
        ...
        if (isNode) {
            ...
            try {
                ...
                let snarky;
                try {
                    snarky = await import(/* webpackIgnore: true */ '../../web_bindings/o1js_web.bc.js');
                }
                catch {
                    try {
                        snarky = await import(/* webpackIgnore: true */ '../compiled/web_bindings/o1js_web.bc.js');
                    }
                    catch {
...
async function loadBrowserWASM() {
    try {
        ...
        sparkyWasm = await import(/* webpackIgnore: true */ '../compiled/sparky_web/sparky_wasm.js');
    }
    catch (error) {
 ...
 */
export function getSparkyInstance() {
    if (!sparkyInstance) {
 ...
 * Get OCaml modules
 */
export function getOCamlModules() {
