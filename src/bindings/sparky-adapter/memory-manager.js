 ...
 */
export class WitnessMemoryStoreImpl {
    constructor() {
        this.store = new Map();
    }
    /**
 ...
 */
export function getWitnessStore() {
 ...
 */
export function resetWitnessStore() {
    if (globalWitnessStore) {
 ...
 */
export function tryGarbageCollection() {
 ...
 */
export function computeWithMemoryPressure(compute, cvar) {
    const store = getWitnessStore();
