 ...
 */
export function cvarToFieldVar(cvar) {
 ...
 */
export function fieldVarToCvar(fieldVar) {
 ...
 * @returns FieldVar in o1js format
 */
export function toSparkyField(field) {
 ...
 */
export function ensureFieldVar(value) {
 ...
 */
export function mlArrayToJsArray(mlArray) {
 ...
 */
export function jsArrayToMlArray(jsArray) {
 ...
 */
export function cvarsToFieldVars(cvars) {
 ...
 */
export function fieldVarsToCvars(fieldVars) {
 ...
 */
export function coeffToString(coeff) {
 ...
 */
export function coeffsToStrings(coeffs) {
 ...
 */
export function isValidCvar(value) {
 ...
 */
export function isValidFieldVar(value) {
