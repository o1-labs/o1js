...
const FeePayerBody: BindingsType.Object<FeePayerBody> = new BindingsType.Object(
  {
    ...
    entries: {
      ...
      validUntil: new BindingsType.Option.OrUndefined<UInt32>(
        new BindingsType.Leaf.UInt32()
      ),
...
const VerificationKeyWithHash: BindingsType.Object<VerificationKeyWithHash> =
  new BindingsType.Object({
    ...
    keys: ['data', 'hash'],
    entries: {
      data: new BindingsType.Leaf.String(),
...
const EpochLedgerPrecondition: BindingsType.Object<EpochLedgerPrecondition> =
  new BindingsType.Object({
    ...
    entries: {
      ...
      totalCurrency: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt64()
      ),
    },
  });
...
const AccountPrecondition: BindingsType.Object<AccountPrecondition> =
  new BindingsType.Object({
    ...
    entries: {
      balance: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt64()
      ),
      nonce: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
      receiptChainHash: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Field()
      ),
      delegate: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.PublicKey()
      ),
      state: new BindingsType.Array({
        staticLength: 8,
        inner: new BindingsType.Option.Flagged(new BindingsType.Leaf.Field()),
      }),
      actionState: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Field()
      ),
      provedState: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Bool()
      ),
...
const Control: BindingsType.Object<Control> = new BindingsType.Object({
  ...
  entries: {
    proof: new BindingsType.Option.OrUndefined<string>(
      new BindingsType.Leaf.String()
    ),
    signature: new BindingsType.Option.OrUndefined<string>(
      new BindingsType.Leaf.String()
    ),
  },
});
...
const AccountTiming: BindingsType.Object<AccountTiming> =
  new BindingsType.Object({
    name: 'AccountTiming',
    keys: [
      'isTimed',
...
const ZkappFeePayer: BindingsType.Object<ZkappFeePayer> =
  new BindingsType.Object({
    name: 'ZkappFeePayer',
    keys: ['body', 'authorization'],
    entries: {
      body: FeePayerBody,
      authorization: new BindingsType.Leaf.String(),
    },
  });
type Permissions = {
...
const EpochDataPrecondition: BindingsType.Object<EpochDataPrecondition> =
  new BindingsType.Object({
    ...
    entries: {
      ...
      startCheckpoint: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Field()
      ),
      lockCheckpoint: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Field()
      ),
      epochLength: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
    },
  });
...
const ZkappAccount: BindingsType.Object<ZkappAccount> = new BindingsType.Object(
  {
    ...
    entries: {
      ...
      verificationKey: new BindingsType.Option.OrUndefined<{
        data: string;
        hash: Field;
      }>(VerificationKeyWithHash),
...
const AccountUpdateModification: BindingsType.Object<AccountUpdateModification> =
  new BindingsType.Object({
    ...
    entries: {
      ...
      zkappUri: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.ZkappUri()
      ),
      tokenSymbol: new BindingsType.Option.Flagged(
...
const NetworkPrecondition: BindingsType.Object<NetworkPrecondition> =
  new BindingsType.Object({
    ...
    entries: {
      snarkedLedgerHash: new BindingsType.Option.Flagged(
        new BindingsType.Leaf.Field()
      ),
      blockchainLength: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
      minWindowDensity: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
      totalCurrency: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt64()
      ),
      globalSlotSinceGenesis: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
...
const Account: BindingsType.Object<Account> = new BindingsType.Object({
  ...
  entries: {
    ...
    delegate: new BindingsType.Option.OrUndefined<PublicKey>(
      new BindingsType.Leaf.PublicKey()
    ),
...
const Preconditions: BindingsType.Object<Preconditions> =
  new BindingsType.Object({
    name: 'Preconditions',
    ...
    entries: {
      ...
      validWhile: new BindingsType.Option.ClosedInterval(
        new BindingsType.Leaf.UInt32()
      ),
    },
  });
...
const AccountUpdateBody: BindingsType.Object<AccountUpdateBody> =
  new BindingsType.Object({
