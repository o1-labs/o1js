...
export { Types, ZkappCommand, ZkappFeePayer, FeePayerBody, ZkappAccountUpdate, AccountUpdateBody, AccountUpdateModification, VerificationKeyWithHash, Permissions, VerificationKeyPermission, Timing, Preconditions, NetworkPrecondition, EpochDataPrecondition, EpochLedgerPrecondition, AccountPrecondition, MayUseToken, AuthorizationKindStructured, Control, Account, AccountTiming, ZkappAccount };
     type FeePayerBody = {"publicKey": PublicKey, "fee": UInt64, "validUntil": UInt32 | undefined, "nonce": UInt32};
     const FeePayerBody: BindingsType.Object<FeePayerBody> = new BindingsType.Object({
       name: 'FeePayerBody',
       keys: ["publicKey","fee","validUntil","nonce"],
       entries: {"publicKey": new BindingsType.Leaf.PublicKey, "fee": new BindingsType.Leaf.UInt64, "validUntil": new BindingsType.Option.OrUndefined<UInt32>(new BindingsType.Leaf.UInt32), "nonce": new BindingsType.Leaf.UInt32}
     });
     type VerificationKeyWithHash = {"data": string, "hash": Field};
     const VerificationKeyWithHash: BindingsType.Object<VerificationKeyWithHash> = new BindingsType.Object({
     ...
     const VerificationKeyPermission: BindingsType.Object<VerificationKeyPermission> = new BindingsType.Object({
     ...
     type Timing = {"initialMinimumBalance": UInt64, "cliffTime": UInt32, "cliffAmount": UInt64, "vestingPeriod": UInt32, "vestingIncrement": UInt64};
     ...
     const EpochLedgerPrecondition: BindingsType.Object<EpochLedgerPrecondition> = new BindingsType.Object({
     ...
     type AccountPrecondition = {"balance": Option<Range<UInt64>>, "nonce": Option<Range<UInt32>>, "receiptChainHash": Option<Field>, "delegate": Option<PublicKey>, "state": Option<Field>[], "actionState": Option<Field>, "provedState": Option<Bool>, "isNew": Option<Bool>};
     ...
     const AuthorizationKindStructured: BindingsType.Object<AuthorizationKindStructured> = new BindingsType.Object({
     ...
     const Control: BindingsType.Object<Control> = new BindingsType.Object({
       ...
       entries: {"proof": new BindingsType.Option.OrUndefined<string>(new BindingsType.Leaf.String), "signature": new BindingsType.Option.OrUndefined<string>(new BindingsType.Leaf.String)}
     });
     type AccountTiming = {"isTimed": Bool, "initialMinimumBalance": UInt64, "cliffTime": UInt32, "cliffAmount": UInt64, "vestingPeriod": UInt32, "vestingIncrement": UInt64};
     ...
     type ZkappFeePayer = {"body": {"publicKey": PublicKey, "fee": UInt64, "validUntil": UInt32 | undefined, "nonce": UInt32}, "authorization": string};
     ...
     type Permissions = {"editState": AuthRequired, "access": AuthRequired, "send": AuthRequired, "receive": AuthRequired, "setDelegate": AuthRequired, "setPermissions": AuthRequired, "setVerificationKey": {"auth": AuthRequired, "txnVersion": UInt32}, "setZkappUri": AuthRequired, "editActionState": AuthRequired, "setTokenSymbol": AuthRequired, "incrementNonce": AuthRequired, "setVotingFor": AuthRequired, "setTiming": AuthRequired};
     ...
     type EpochDataPrecondition = {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>};
     ...
     type ZkappAccount = {"appState": Field[], "verificationKey": {"data": string, "hash": Field} | undefined, "zkappVersion": UInt32, "actionState": Field[], "lastActionSlot": UInt32, "provedState": Bool, "zkappUri": string};
     ...
     type NetworkPrecondition = {"snarkedLedgerHash": Option<Field>, "blockchainLength": Option<Range<UInt32>>, "minWindowDensity": Option<Range<UInt32>>, "totalCurrency": Option<Range<UInt64>>, "globalSlotSinceGenesis": Option<Range<UInt32>>, "stakingEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}, "nextEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}};
     ...
     const Account: BindingsType.Object<Account> = new BindingsType.Object({
       ...
       entries: {"publicKey": new BindingsType.Leaf.PublicKey, "tokenId": new BindingsType.Leaf.TokenId, "tokenSymbol": new BindingsType.Leaf.String, "balance": new BindingsType.Leaf.UInt64, "nonce": new BindingsType.Leaf.UInt32, "receiptChainHash": new BindingsType.Leaf.Field, "delegate": new BindingsType.Option.OrUndefined<PublicKey>(new BindingsType.Leaf.PublicKey), "votingFor": new BindingsType.Leaf.Field, "timing": AccountTiming, "permissions": Permissions, "zkapp": new BindingsType.Option.OrUndefined<{"appState": Field[], "verificationKey": {"data": string, "hash": Field} | undefined, "zkappVersion": UInt32, "actionState": Field[], "lastActionSlot": UInt32, "provedState": Bool, "zkappUri": string}>(ZkappAccount)}
     });
     type Preconditions = {"network": {"snarkedLedgerHash": Option<Field>, "blockchainLength": Option<Range<UInt32>>, "minWindowDensity": Option<Range<UInt32>>, "totalCurrency": Option<Range<UInt64>>, "globalSlotSinceGenesis": Option<Range<UInt32>>, "stakingEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}, "nextEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}}, "account": {"balance": Option<Range<UInt64>>, "nonce": Option<Range<UInt32>>, "receiptChainHash": Option<Field>, "delegate": Option<PublicKey>, "state": Option<Field>[], "actionState": Option<Field>, "provedState": Option<Bool>, "isNew": Option<Bool>}, "validWhile": Option<Range<UInt32>>};
     ...
     type ZkappAccountUpdate = {"body": {"publicKey": PublicKey, "tokenId": TokenId, "update": {"appState": Option<Field>[], "delegate": Option<PublicKey>, "verificationKey": Option<{"data": string, "hash": Field}>, "permissions": Option<{"editState": AuthRequired, "access": AuthRequired, "send": AuthRequired, "receive": AuthRequired, "setDelegate": AuthRequired, "setPermissions": AuthRequired, "setVerificationKey": {"auth": AuthRequired, "txnVersion": UInt32}, "setZkappUri": AuthRequired, "editActionState": AuthRequired, "setTokenSymbol": AuthRequired, "incrementNonce": AuthRequired, "setVotingFor": AuthRequired, "setTiming": AuthRequired}>, "zkappUri": Option<ZkappUri>, "tokenSymbol": Option<TokenSymbol>, "timing": Option<{"initialMinimumBalance": UInt64, "cliffTime": UInt32, "cliffAmount": UInt64, "vestingPeriod": UInt32, "vestingIncrement": UInt64}>, "votingFor": Option<StateHash>}, "balanceChange": Int64, "incrementNonce": Bool, "events": Events, "actions": Actions, "callData": Field, "callDepth": number, "preconditions": {"network": {"snarkedLedgerHash": Option<Field>, "blockchainLength": Option<Range<UInt32>>, "minWindowDensity": Option<Range<UInt32>>, "totalCurrency": Option<Range<UInt64>>, "globalSlotSinceGenesis": Option<Range<UInt32>>, "stakingEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}, "nextEpochData": {"ledger": {"hash": Option<Field>, "totalCurrency": Option<Range<UInt64>>}, "seed": Option<Field>, "startCheckpoint": Option<Field>, "lockCheckpoint": Option<Field>, "epochLength": Option<Range<UInt32>>}}, "account": {"balance": Option<Range<UInt64>>, "nonce": Option<Range<UInt32>>, "receiptChainHash": Option<Field>, "delegate": Option<PublicKey>, "state": Option<Field>[], "actionState": Option<Field>, "provedState": Option<Bool>, "isNew": Option<Bool>}, "validWhile": Option<Range<UInt32>>}, "useFullCommitment": Bool, "implicitAccountCreationFee": Bool, "mayUseToken": {"parentsOwnToken": Bool, "inheritFromParent": Bool}, "authorizationKind": {"isSigned": Bool, "isProved": Bool, "verificationKeyHash": Field}}, "authorization": {"proof": string | undefined, "signature": string | undefined}};
   ...
   const Types: {[key: string]: BindingsType<any>} = {ZkappCommand, ZkappFeePayer, FeePayerBody, ZkappAccountUpdate, AccountUpdateBody, AccountUpdateModification, VerificationKeyWithHash, Permissions, VerificationKeyPermission, Timing, Preconditions, NetworkPrecondition, EpochDataPrecondition, EpochLedgerPrecondition, AccountPrecondition, MayUseToken, AuthorizationKindStructured, Control, Account, AccountTiming, ZkappAccount};
