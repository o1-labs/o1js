...
type CustomTypes = { TransactionVersion: Signable<UInt32, Json.TypeMap["UInt32"]>; ZkappUri: Signable<{
        data: string;
        hash: Field;
      }, string>; TokenSymbol: Signable<{
        symbol: string;
        field: Field;
      }, string>; StateHash: Signable<Field, Json.TypeMap["Field"]>; BalanceChange: Signable<BalanceChange, {
      magnitude: Json.TypeMap["UInt64"];
      sgn: Json.TypeMap["Sign"];
    }>; Events: Signable<{
      data: Field[][];
      hash: Field;
    }, Json.TypeMap["Field"][][]>; Actions: Signable<{
      data: Field[][];
      hash: Field;
    }, Json.TypeMap["Field"][][]>; ActionState: Signable<Field, Json.TypeMap["Field"]>; MayUseToken: Signable<{
      parentsOwnToken: Bool;
      inheritFromParent: Bool;
    }, {
      parentsOwnToken: Json.TypeMap["Bool"];
      inheritFromParent: Json.TypeMap["Bool"];
    }>; VerificationKeyHash: Signable<Field, Json.TypeMap["Field"]>; ReceiptChainHash: Signable<Field, Json.TypeMap["Field"]>; }
...
let { signableFromLayout, toJSONEssential, empty } = SignableFromLayout<TypeMap, Json.TypeMap>(TypeMap, customTypes);
...
let ZkappCommand = signableFromLayout<ZkappCommand, Json.ZkappCommand>(jsLayout.ZkappCommand as any);
...
let AccountUpdate = signableFromLayout<AccountUpdate, Json.AccountUpdate>(jsLayout.AccountUpdate as any);
