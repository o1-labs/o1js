...
exports.mlBytesToUint8Array = exports.mlBytesFromUint8Array = exports.MlBytes = exports.fromMlString = exports.toMlStringAscii = exports.Bigint256Bindings = void 0;
const base_js_1 = require("../../../lib/ml/base.js");
const util_js_1 = require("./util.js");
const Bigint256Bindings = (0, util_js_1.withPrefix)('caml_bigint_256', {
    // TODO
    of_numeral(s, i, j) {
    ...
    test_bit(b, i) {
        return (0, base_js_1.MlBool)(!!(b[1] & (1n << BigInt(i))));
    },
    to_bytes([, x]) {
...
exports.Bigint256Bindings = Bigint256Bindings;
...
exports.fromMlString = fromMlString;
function toMlStringAscii(s) {
    return new MlBytes(9, s, s.length);
}
exports.toMlStringAscii = toMlStringAscii;
...
exports.mlBytesFromUint8Array = mlBytesFromUint8Array;
...
exports.mlBytesToUint8Array = mlBytesToUint8Array;
class MlBytes {
