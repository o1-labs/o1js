...
exports.mapToUint32Array = exports.mapFromUintArray = exports.unwrap = exports.wrap = exports.freeOnFinalize = exports.conversionCore = void 0;
...
exports.conversionCore = conversionCore;
function conversionCorePerField(wasm, { CommitmentCurve, makeAffine, Gate, PolyComm }) {
    let self = {
        wireToRust([, row, col]) {
            return wasm.Wire.create(row, col);
        },
        vectorToRust: conversion_base_js_1.fieldsToRustFlat,
        vectorFromRust: conversion_base_js_1.fieldsFromRustFlat,
        gateToRust(gate) {
            let [, typ, [, ...wires], coeffs] = gate;
            let rustWires = new wasm.WasmGateWires(...(0, util_js_1.mapTuple)(wires, self.wireToRust));
            let rustCoeffs = (0, conversion_base_js_1.fieldsToRustFlat)(coeffs);
        ...
        pointToRust(point) {
            return (0, conversion_base_js_1.affineToRust)(point, makeAffine);
        },
        pointFromRust: conversion_base_js_1.affineFromRust,
        pointsToRust([, ...points]) {
            return mapToUint32Array(points, (point) => unwrap(self.pointToRust(point)));
        },
        pointsFromRust(points) {
            let arr = mapFromUintArray(points, (ptr) => (0, conversion_base_js_1.affineFromRust)(wrap(ptr, CommitmentCurve)));
            return [0, ...arr];
        },
        ...
        polyCommFromRust(polyComm) {
            ...
            let mlUnshifted = mapFromUintArray(rustUnshifted, (ptr) => {
                return (0, conversion_base_js_1.affineFromRust)(wrap(ptr, CommitmentCurve));
            });
...
exports.freeOnFinalize = freeOnFinalize;
...
exports.mapFromUintArray = mapFromUintArray;
...
exports.mapToUint32Array = mapToUint32Array;
