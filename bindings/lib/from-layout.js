...
exports.genericLayoutFold = exports.SignableFromLayout = exports.ProvableFromLayout = void 0;
...
function SignableFromLayout(TypeMap, customTypes) {
    ...
    function fromJSON(typeData, json) {
        ...
        if (generic_js_1.primitiveTypes.has(typeData.type)) {
            return generic_js_1.primitiveTypeMap[typeData.type].fromJSON(json);
        }
...
function ProvableFromLayout(TypeMap, customTypes) {
    ...
    function fromFields(typeData, fields, aux) {
        ...
        if (generic_js_1.primitiveTypes.has(typeData.type)) {
            return generic_js_1.primitiveTypeMap[typeData.type].fromFields(fields, aux);
        }
...
function genericLayoutFold(TypeMap, customTypes, spec, typeData, value) {
    ...
    if (generic_js_1.primitiveTypes.has(typeData.type)) {
        return spec.map(generic_js_1.primitiveTypeMap[typeData.type], value, typeData.type);
    }
    return spec.map(TypeMap[typeData.type], value, typeData.type);
}
exports.genericLayoutFold = genericLayoutFold;
