/**
 * Minimal Constraint System Divergence Test (CommonJS)
 * 
...
let o1js, Field, ZkProgram, Provable, switchBackend, getCurrentBackend;

async function loadO1js() {
  o1js = await import('./dist/node/index.js');
  ({ Field, ZkProgram, Provable, switchBackend, getCurrentBackend } = o1js);
}
...
async function compareConstraintSystems() {
  ...
  // Define zkProgram after loading o1js
