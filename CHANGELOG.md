...
## [Unreleased](https://github.com/o1-labs/o1js/compare/250abd98d...HEAD)

## [2.5.1](https://github.com/o1-labs/o1js/compare/1ad7333e9e...250abd98d) - 2025-05-27

### Added

- [PR! 1905](https://github.com/o1-labs/o1js/pull/1905) API support for circuit chunking [WIP]
  - still requires memory optimizations to be fully functional
