...
- `Mina.LocalBlockchain()` was made async https://github.com/o1-labs/o1js/pull/1583
  - This was the last remaining sync API that depended on an async setup task; making it async enables removing top-level await
