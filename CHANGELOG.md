...
- **Remove deprecated APIs**
  ...
  - Remove `Mina.accountCreationFee` (use `Mina.getNetworkConstants().accountCreationFee`), `Mina.BerkeleyQANet`, APIs which accept private keys for feepayers, `Token`, `AccountUpdate.tokenSymbol`
