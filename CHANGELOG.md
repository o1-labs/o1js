...
- **Remove deprecated APIs**
  ...
  - Remove `Mina.accountCreationFee`, `Mina.BerkeleyQANet`, APIs which accept private keys for feepayers, `Token`, `AccountUpdate.tokenSymbol`, `SmartContract.{token, setValue, setPermissions}`
