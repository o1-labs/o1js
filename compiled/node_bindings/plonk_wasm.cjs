...
class WasmFqLookupVerifierIndex {
    ...
    */
    get joint_lookup_used() {
        const ret = wasm.__wbg_get_wasmfqlookupverifierindex_joint_lookup_used(this.ptr);
        return ret !== 0;
    }
    /**
    * @param {boolean} arg0
    */
    set joint_lookup_used(arg0) {
        wasm.__wbg_set_wasmfqlookupverifierindex_joint_lookup_used(this.ptr, arg0);
    }
    /**
    * @param {boolean} joint_lookup_used
    * @param {Uint32Array} lookup_table
    ...
    */
    get lookup_selectors() {
        const ret = wasm.wasmfqlookupverifierindex_lookup_selectors(this.ptr);
        return WasmFqLookupSelectors.__wrap(ret);
    }
    /**
    ...
    */
    set lookup_selectors(x) {
        ...
        var ptr0 = x.__destroy_into_raw();
        wasm.wasmfqlookupverifierindex_set_lookup_selectors(this.ptr, ptr0);
    }
    /**
    * @returns {WasmFqPolyComm | undefined}
    */
    get table_ids() {
        const ret = wasm.wasmfqlookupverifierindex_table_ids(this.ptr);
        return ret === 0 ? undefined : WasmFqPolyComm.__wrap(ret);
    }
    /**
    * @param {WasmFqPolyComm | undefined} x
    */
    set table_ids(x) {
        ...
        wasm.wasmfqlookupverifierindex_set_table_ids(this.ptr, ptr0);
    }
    /**
    * @returns {WasmFqPolyComm | undefined}
    */
    get runtime_tables_selector() {
        const ret = wasm.wasmfqlookupverifierindex_runtime_tables_selector(this.ptr);
        return ret === 0 ? undefined : WasmFqPolyComm.__wrap(ret);
    }
    /**
    * @param {WasmFqPolyComm | undefined} x
    */
    set runtime_tables_selector(x) {
        ...
        wasm.wasmfqlookupverifierindex_set_runtime_tables_selector(this.ptr, ptr0);
    }
}
