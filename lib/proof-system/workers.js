...
exports.WithThreadPool = exports.setNumberOfWorkers = exports.workers = void 0;
const workers = {
 ...
 * ```
 */
const setNumberOfWorkers = (numWorkers) => {
    workers.numWorkers = numWorkers;
};
exports.setNumberOfWorkers = setNumberOfWorkers;
...
exports.WithThreadPool = WithThreadPool;
