...
exports.declareMethods = exports.method = exports.SmartContract = void 0;
...
const Encoding = require("../../../bindings/lib/encoding.js");
...
const proof_js_1 = require("../../proof-system/proof.js");
...
const cache_js_1 = require("../../proof-system/cache.js");
...
const reducer_js_1 = require("./actions/reducer.js");
...
function method(target, methodName, descriptor, returnType) {
    ...
    SelfProof.publicInputType = account_update_js_1.ZkappPublicInput;
    SelfProof.publicOutputType = zkprogram_js_1.Empty;
    SelfProof.tag = () => ZkappClass;
    let internalMethodEntry = (0, zkprogram_js_1.sortMethodArguments)(ZkappClass.name, methodName, paramTypes, undefined, SelfProof);
    // add witness arguments for the publicKey (address) and tokenId
    let methodEntry = (0, zkprogram_js_1.sortMethodArguments)(ZkappClass.name, methodName, [signature_js_1.PublicKey, wrapped_js_1.Field, ...paramTypes], undefined, SelfProof);
...
method.returns = function (returnType) {
    return function decorateMethod(target, methodName, descriptor) {
        return method(target, methodName, descriptor, provable_intf_js_1.ProvableType.get(returnType));
    };
};
...
function wrapMethod(method, ZkappClass, methodIntf) {
    ...
    return async function wrappedMethod(...actualArgs) {
        (0, state_js_1.cleanStatePrecondition)(this);
        ...
        actualArgs.forEach((arg) => {
            if (arg instanceof account_update_js_1.AccountUpdate) {
                account_update_js_1.AccountUpdate.unlink(arg);
            }
        });
        ...
        if (!insideContract) {
            ...
            try {
                if ((0, provable_context_js_1.inCompile)() || (0, provable_context_js_1.inProver)() || (0, provable_context_js_1.inAnalyze)()) {
                    ...
                    let proverData = (0, provable_context_js_1.inProver)() ? account_update_js_1.zkAppProver.getData() : undefined;
                    let txId = Mina.currentTransaction.enter({
                        ...
                        fetchMode: (0, provable_context_js_1.inProver)() ? 'cached' : 'test',
                    ...
                    try {
                        ...
                        let blindingValue = provable_js_1.Provable.witness(wrapped_js_1.Field, provable_js_1.getBlindingValue);
                        ...
                        let memoCtx = (0, provable_js_1.memoizationContext)() ?? {
                            memoized: [],
                            currentIndex: 0,
                        };
                        let id = provable_js_1.memoizationContext.enter({ ...memoCtx, blindingValue });
                        let result;
                        try {
                            let clonedArgs = actualArgs.map(struct_js_1.cloneCircuitValue);
                            result = await (0, assert_js_1.assertPromise)(method.apply(this, clonedArgs), noPromiseError);
                        }
                        finally {
                        ...
                        accountUpdate.body.callData = poseidon_js_1.Poseidon.hash(callDataFields);
                        ...
                        (0, precondition_js_1.cleanPreconditionsCache)(accountUpdate);
                        (0, state_js_1.assertStatePrecondition)(this);
                        return result;
                    }
                    finally {
                    ...
                    let result = await (0, assert_js_1.assertPromise)(method.apply(this, actualArgs), noPromiseError);
                    // check the self accountUpdate right after calling the method
                    // TODO: this needs to be done in a unified way for all account updates that are created
                    (0, precondition_js_1.assertPreconditionInvariants)(this.self);
                    (0, precondition_js_1.cleanPreconditionsCache)(this.self);
                    (0, state_js_1.assertStatePrecondition)(this);
                    return result;
                }
                else {
                    ...
                    let clonedArgs = (0, struct_js_1.cloneCircuitValue)(actualArgs);
                    // we run this in a "memoization context" so that we can remember witnesses for reuse when proving
                    let blindingValue = (0, provable_js_1.getBlindingValue)();
                    let memoContext = { memoized: [], currentIndex: 0, blindingValue };
                    let memoId = provable_js_1.memoizationContext.enter(memoContext);
                    let result;
                    try {
                        result = await (0, assert_js_1.assertPromise)(method.apply(this, actualArgs.map((a, i) => {
                            return provable_js_1.Provable.witness(methodIntf.args[i], () => a);
                        })), noPromiseError);
                    }
                    finally {
                        provable_js_1.memoizationContext.leave(memoId);
                    }
                    ...
                    accountUpdate.body.callData = poseidon_js_1.Poseidon.hash(callDataFields);
                    if (!account_update_js_1.Authorization.hasAny(accountUpdate)) {
                    ...
                    if ((0, provable_context_js_1.inCheckedComputation)()) {
                        provable_js_1.Provable.asProver(() => {
                            accountUpdate = provable_js_1.Provable.toConstant(account_update_js_1.AccountUpdate, accountUpdate);
                ...
                smart_contract_context_js_1.smartContractContext.leave(id);
            }
        }
        ...
        try {
            ...
            let runCalledContract = async () => {
                let constantArgs = methodIntf.args.map((type, i) => provable_js_1.Provable.toConstant(type, actualArgs[i]));
                ...
                let result;
                try {
                    result = await (0, assert_js_1.assertPromise)(method.apply(this, constantArgs.map(struct_js_1.cloneCircuitValue)), noPromiseError);
                }
                finally {
                    provable_js_1.memoizationContext.leave(memoId);
                }
                ...
                if (result !== undefined) {
                    ...
                    (0, common_js_1.assert)(returnType !== undefined, "Bug: returnType is undefined but the method result isn't.");
                    result = provable_js_1.Provable.toConstant(returnType, result);
                }
                // store inputs + result in callData
                let callDataFields = computeCallData(methodIntf, constantArgs, result, constantBlindingValue);
                accountUpdate.body.callData = (0, poseidon_js_1.hashConstant)(callDataFields);
                if (!account_update_js_1.Authorization.hasAny(accountUpdate)) {
                    ProofAuthorization.setLazyProof(accountUpdate, {
                        methodName: methodIntf.methodName,
                        args: constantArgs,
                        ...
                        memoized,
                        blindingValue: constantBlindingValue,
                    }, Mina.currentTransaction()?.layout ?? new account_update_js_1.AccountUpdateLayout());
                }
            ...
            let { accountUpdate, result: { result, children }, } = await account_update_js_1.AccountUpdate.witness((0, provable_derivers_js_1.provable)({
                result: methodIntf.returnType ?? (0, provable_derivers_js_1.provable)(null),
                children: account_update_js_1.AccountUpdateForest,
            ...
            (0, common_js_1.assert)(accountUpdate.body.authorizationKind.isProved, 'callee is proved');
            // assert that the inputs & outputs we have match what the callee put on its callData
            let callDataFields = computeCallData(methodIntf, actualArgs, result, blindingValue);
            let callData = poseidon_js_1.Poseidon.hash(callDataFields);
...
function computeCallData(methodIntf, argumentValues, returnValue, blindingValue) {
    ...
    let args = methodIntf.args.map((type, i) => {
        return { type: provable_intf_js_1.ProvableType.get(type), value: argumentValues[i] };
    });
    let input = { fields: [], packed: [] };
    for (let { type, value } of args) {
        if ((0, poseidon_js_1.isHashable)(type)) {
            input = poseidon_js_1.HashInput.append(input, type.toInput(value));
        }
        else {
            input.fields.push((0, wrapped_js_1.Field)(type.sizeInFields()), ...type.toFields(value));
        }
    }
    const totalArgFields = (0, poseidon_js_1.packToFields)(input);
    let totalArgSize = (0, wrapped_js_1.Field)(args.map(({ type }) => type.sizeInFields()).reduce((s, t) => s + t, 0));
    let returnSize = (0, wrapped_js_1.Field)(returnType?.sizeInFields() ?? 0);
    input = { fields: [], packed: [] };
    if ((0, poseidon_js_1.isHashable)(returnType)) {
        input = poseidon_js_1.HashInput.append(input, returnType.toInput(returnValue));
    }
    else {
        input.fields.push(...(returnType?.toFields(returnValue) ?? []));
    }
    let returnFields = (0, poseidon_js_1.packToFields)(input);
 ...
 *
 */
class SmartContract extends smart_contract_base_js_1.SmartContractBase {
    /**
    ...
    static Proof() {
        var _a;
        let Contract = this;
        return _a = class extends proof_js_1.Proof {
            },
            _a.publicInputType = account_update_js_1.ZkappPublicInput,
            _a.publicOutputType = zkprogram_js_1.Empty,
            _a.tag = () => Contract,
            _a;
    }
    constructor(address, tokenId) {
        ...
        this.sender = {
            ...
            getUnconstrained() {
                ...
                if (__classPrivateFieldGet(this.self, _SmartContract__senderState, "f")?.transactionId === transactionId) {
                    ...
                    sender = provable_js_1.Provable.witness(signature_js_1.PublicKey, () => Mina.sender());
            ...
            getAndRequireSignature() {
                ...
                account_update_js_1.AccountUpdate.createSigned(sender);
                return sender;
            },
        };
        /**
        ...
        this.tokenId = tokenId ?? account_update_js_1.TokenId.default;
        Object.defineProperty(this, 'reducer', {
            ...
            get() {
                return (0, reducer_js_1.getReducer)(this);
            },
        });
    }
    /**
     ...
     */
    static async compile({ cache = cache_js_1.Cache.FileSystemDefault, forceRecompile = false } = {}) {
        ...
        let { verificationKey, provers, verify } = await (0, zkprogram_js_1.compileProgram)({
            publicInputType: account_update_js_1.ZkappPublicInput,
            publicOutputType: zkprogram_js_1.Empty,
            methodIntfs,
            methods,
            gates,
            proofs,
    ...
    static async digest() {
        ...
        let hash = (0, poseidon_js_1.hashConstant)(Object.values(methodData).map((d) => (0, wrapped_js_1.Field)(BigInt('0x' + d.digest))));
    ...
    static async getMaxProofsVerified() {
        let methodData = await this.analyzeMethods();
        return (0, zkprogram_js_1.computeMaxProofsVerified)(Object.values(methodData).map((d) => d.proofs.length));
    }
    /**
    ...
    static setVerificationKeyUnsafe(verificationKey) {
        SmartContract._verificationKey = {
            ...
            hash: wrapped_js_1.Field.from(verificationKey.hash),
        };
    }
    /**
    ...
    async deploy({ verificationKey, } = {}) {
        ...
        if (verificationKey === undefined) {
            if (!Mina.getProofsEnabled()) {
                verificationKey = await verification_key_js_1.VerificationKey.dummy();
            }
            else {
        ...
        let hash = wrapped_js_1.Field.from(hash_);
        accountUpdate.account.verificationKey.set({ hash, data });
        accountUpdate.account.permissions.set(account_update_js_1.Permissions.default());
        accountUpdate.requireSignature();
        account_update_js_1.AccountUpdate.attachToTransaction(accountUpdate);
...
`);
    ...
    init() {
        ...
        this.account.provedState.requireEquals((0, wrapped_js_1.Bool)(false));
        let accountUpdate = this.self;
        // set all state fields to 0
        for (let i = 0; i < mina_instance_js_1.ZkappStateLength; i++) {
            account_update_js_1.AccountUpdate.setValue(accountUpdate.body.update.appState[i], (0, wrapped_js_1.Field)(0));
        }
        // for all explicitly declared states, set them to their default value
        let stateKeys = (0, state_js_1.getLayout)(this.constructor).keys();
     ...
     */
    skipAuthorization() {
        account_update_js_1.Authorization.setLazyNone(this.self);
    }
    /**
    ...
    get self() {
        ...
        let inSmartContract = smart_contract_context_js_1.smartContractContext.get();
    ...
    emitEventIf(condition, type, event) {
        ...
        if (eventTypes.length === 1) {
            ...
            eventFields = [(0, wrapped_js_1.Field)(eventNumber), ...eventType.toFields(event)];
        }
        let newEvents = account_update_js_1.Events.pushEvent(accountUpdate.body.events, eventFields);
        accountUpdate.body.events = provable_js_1.Provable.if(condition, account_update_js_1.Events, newEvents, accountUpdate.body.events);
    }
    /**
     * Emits an event. Events will be emitted as a part of the transaction and can be collected by archive nodes.
     */
    emitEvent(type, event) {
        this.emitEventIf((0, wrapped_js_1.Bool)(true), type, event);
    }
    /**
     ...
     * console.log(events);
     */
    async fetchEvents(start = int_js_1.UInt32.from(0), end) {
        ...
        if (start.greaterThan(int_js_1.UInt32.from(0)).toBoolean()) {
        ...
        return events.map((eventData) => {
            ...
            if (sortedEventTypes.length === 1) {
                ...
                let event = this.events[type].fromFields(eventData.event.data.map((f) => (0, wrapped_js_1.Field)(f)));
                return {
                    ...eventData,
                    type,
                    event: {
                ...
                let event = this.events[type].fromFields(eventProps.map((f) => (0, wrapped_js_1.Field)(f)));
                return {
                    ...eventData,
                    type,
                    event: {
    ...
    static runOutsideCircuit(run) {
        if (Mina.currentTransaction()?.isFinalRunOutsideCircuit || (0, provable_context_js_1.inProver)())
            provable_js_1.Provable.asProver(run);
    }
    ...
    static async analyzeMethods({ printSummary = false } = {}) {
        ...
        if (!methodIntfs.every((m) => m.methodName in methodMetadata) && !(0, provable_context_js_1.inAnalyze)()) {
            let id;
            let insideSmartContract = !!smart_contract_context_js_1.smartContractContext.get();
            if (insideSmartContract)
                id = smart_contract_context_js_1.smartContractContext.enter(null);
            try {
                for (let methodIntf of methodIntfs) {
                    let accountUpdate;
                    let { rows, digest, gates, summary, proofs } = await (0, zkprogram_js_1.analyzeMethod)(account_update_js_1.ZkappPublicInput, methodIntf, async (publicInput, publicKey, tokenId, ...args) => {
...
function selfAccountUpdate(zkapp, methodName) {
    let body = account_update_js_1.Body.keepAll(zkapp.address, zkapp.tokenId);
    let update = new account_update_js_1.AccountUpdate(body, {}, true);
...
const SmartContractContext = {
    enter(self, selfUpdate) {
        let context = {
            this: self,
            selfUpdate,
            selfLayout: new account_update_js_1.AccountUpdateLayout(selfUpdate),
        };
        let id = smart_contract_context_js_1.smartContractContext.enter(context);
        return { id, context };
    },
};
...
exports.declareMethods = declareMethods;
const ProofAuthorization = {
    setKind({ body, id }, priorAccountUpdates) {
        body.authorizationKind.isSigned = (0, wrapped_js_1.Bool)(false);
        body.authorizationKind.isProved = (0, wrapped_js_1.Bool)(true);
        let hash = provable_js_1.Provable.witness(wrapped_js_1.Field, () => {
            let proverData = account_update_js_1.zkAppProver.getData();
            let isProver = proverData !== undefined;
            (0, common_js_1.assert)(isProver || priorAccountUpdates !== undefined, 'Called `setKind()` outside the prover without passing in `priorAccountUpdates`.');
            let myAccountUpdateId = isProver ? proverData.accountUpdate.id : id;
            let priorAccountUpdatesFlat = priorAccountUpdates?.toFlatList({
                mutate: false,
            });
            priorAccountUpdatesFlat ?? (priorAccountUpdatesFlat = proverData.transaction.accountUpdates);
            ...
            try {
                ...
                return account.zkapp?.verificationKey?.hash ?? (0, wrapped_js_1.Field)(0);
            }
            catch {
                return (0, wrapped_js_1.Field)(0);
            }
        });
...
function debugPublicInput(accountUpdate) {
    ...
    provable_js_1.Provable.asProver(() => {
        diffRecursive(accountUpdate, account_update_js_1.zkAppProver.getData());
    });
}
function diffRecursive(prover, inputData) {
    ...
    // TODO
    let proverChildren = (0, smart_contract_context_js_1.accountUpdateLayout)()?.get(prover)?.children.mutable;
...
function diff(transaction, index, prover, input) {
    ...
    if (JSON.stringify(prover) !== JSON.stringify(input)) {
        console.log('transaction:', account_update_js_1.ZkappCommand.toPretty(transaction));
