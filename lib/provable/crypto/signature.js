...
let PrivateKey = (() => {
    ...
    return _a = class PrivateKey extends _classSuper {
            constructor(s) {
                super(s);
                this.s = __runInitializers(this, _s_initializers, void 0);
             ...
             */
            static random() {
                return new _a(wrapped_js_1.Scalar.random());
            }
            /**
             ...
             */
            static fromBits(bs) {
                return new _a(wrapped_js_1.Scalar.fromBits(bs));
            }
            /**
            ...
            static fromBigInt(sk) {
                return new _a(wrapped_js_1.Scalar.from(sk));
            }
            /**
            ...
            static fromBase58(privateKeyBase58) {
                ...
                return new _a(wrapped_js_1.Scalar.from(scalar));
            }
            /**
...
let PublicKey = (() => {
    ...
    return _a = class PublicKey extends _classSuper {
            /**
            ...
            static fromGroup({ x, y }) {
                return _a.fromObject({ x, isOdd: y.isOdd() });
            }
            /**
            ...
            static fromPrivateKey({ s }) {
                return _a.fromGroup(wrapped_js_1.Group.generator.scale(s));
            }
            /**
             ...
             */
            static from(g) {
                return _a.fromObject({ x: wrapped_js_1.Field.from(g.x), isOdd: (0, wrapped_js_1.Bool)(g.isOdd) });
            }
            /**
             ...
             */
            static empty() {
                return _a.from({ x: 0n, isOdd: false });
            }
            /**
            ...
            static fromBase58(publicKeyBase58) {
                ...
                return _a.from({ x: (0, wrapped_js_1.Field)(x), isOdd: (0, wrapped_js_1.Bool)(!!isOdd) });
            }
            /**
            ...
            static fromJSON(publicKey) {
                return _a.fromBase58(publicKey);
            }
            static toValue({ x, isOdd }) {
                return { x: x.toBigInt(), isOdd: isOdd.toBoolean() };
            }
            static fromValue({ x, isOdd }) {
                return _a.from({ x: wrapped_js_1.Field.from(x), isOdd: (0, wrapped_js_1.Bool)(isOdd) });
            }
            constructor() {
                super(...arguments);
                ...
                this.isOdd = (__runInitializers(this, _x_extraInitializers), __runInitializers(this, _isOdd_initializers, void 0));
...
let Signature = (() => {
    ...
    let _s_initializers = [];
    let _s_extraInitializers = [];
    return _a = class Signature extends _classSuper {
            /**
            ...
            static fromBase58(signatureBase58) {
                ...
                return _a.fromObject({ r: (0, wrapped_js_1.Field)(r), s: wrapped_js_1.Scalar.from(s) });
            }
            /**
            ...
            static fromValue({ r, s }) {
                return _a.fromObject({ r: wrapped_js_1.Field.from(r), s: wrapped_js_1.Scalar.from(s) });
            }
            constructor() {
                super(...arguments);
                this.r = __runInitializers(this, _r_initializers, void 0);
                this.s = (__runInitializers(this, _r_extraInitializers), __runInitializers(this, _s_initializers, void 0));
                __runInitializers(this, _s_extraInitializers);
            }
        },
        (() => {
