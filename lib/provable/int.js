...
let UInt64 = (() => {
    ...
    return _a = class UInt64 extends _classSuper {
            /**
             ...
             */
            constructor(x) {
                if (x instanceof _a || x instanceof UInt32)
                    x = x.value.value;
            ...
            toUInt32Clamped() {
                let max = (1n << 32n) - 1n;
                let field = provable_js_1.Provable.if(this.greaterThan(_a.from(max)), wrapped_js_1.Field.from(max), this.value);
                return UInt32.Unsafe.fromField(field);
            }
            static check(x) {
                RangeCheck.rangeCheckN(_a.NUM_BITS, x.value);
            }
            static toInput(x) {
             ...
             */
            static MAXINT() {
                return new _a((1n << 64n) - 1n);
            }
            /**
             * Addition modulo 2^64. Check {@link Gadgets.addMod64} for a detailed description.
             */
            addMod64(y) {
                return new _a((0, arithmetic_js_1.addMod64)(this.value, y.value).value);
            }
            /**
            ...
            divMod(y) {
                ...
                RangeCheck.rangeCheckN(_a.NUM_BITS, q);
                // TODO: Could be a bit more efficient
                let r = x.sub(q.mul(y_)).seal();
                RangeCheck.rangeCheckN(_a.NUM_BITS, r);
                let r_ = new _a(r.value);
                let q_ = new _a(q.value);
                r_.assertLessThan(new _a(y_.value));
             ...
             */
            mul(y) {
                let z = this.value.mul(_a.from(y).value);
                RangeCheck.rangeCheckN(_a.NUM_BITS, z);
                return new _a(z.value);
            }
            /**
             * Addition with overflow checking.
             */
            add(y) {
                let z = this.value.add(_a.from(y).value);
                RangeCheck.rangeCheckN(_a.NUM_BITS, z);
                return new _a(z.value);
            }
            /**
             ...
             */
            sub(y) {
                let z = this.value.sub(_a.from(y).value);
                RangeCheck.rangeCheckN(_a.NUM_BITS, z);
                return new _a(z.value);
            }
            /**
             ...
             */
            xor(x) {
                return new _a(Bitwise.xor(this.value, x.value, _a.NUM_BITS).value);
            }
            /**
             ...
             */
            not() {
                return new _a(Bitwise.not(this.value, _a.NUM_BITS, false).value);
            }
            /**
            ...
            rotate(bits, direction = 'left') {
                return new _a(Bitwise.rotate64(this.value, bits, direction).value);
            }
            /**
             ...
             */
            leftShift(bits) {
                return new _a(Bitwise.leftShift64(this.value, bits).value);
            }
            /**
             ...
             */
            rightShift(bits) {
                return new _a(Bitwise.rightShift64(this.value, bits).value);
            }
            /**
             ...
             */
            and(x) {
                return new _a(Bitwise.and(this.value, x.value, _a.NUM_BITS).value);
            }
            /**
             ...
             */
            or(x) {
                return new _a(Bitwise.or(this.value, x.value, _a.NUM_BITS).value);
            }
            /**
            ...
            lessThanOrEqual(y) {
                ...
                return (0, comparison_js_1.lessThanOrEqualGeneric)(this.value, y.value, 1n << 64n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            assertLessThanOrEqual(y, message) {
                ...
                (0, comparison_js_1.assertLessThanOrEqualGeneric)(this.value, y.value, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v, message));
            }
            /**
             *
            ...
            lessThan(y) {
                ...
                return (0, comparison_js_1.lessThanGeneric)(this.value, y.value, 1n << 64n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            assertLessThan(y, message) {
                ...
                (0, comparison_js_1.assertLessThanGeneric)(this.value, y.value, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v, message));
            }
            /**
            ...
            static fromBytes(bytes) {
                ...
                return _a.Unsafe.fromField((0, bit_slices_js_1.bytesToWord)(bytes));
            }
            /**
             * Combine 8 UInt8s into a UInt64, in big-endian order.
             */
            static fromBytesBE(bytes) {
                return _a.fromBytes([...bytes].reverse());
            }
            /**
            ...
            static fromBits(bits) {
                ...
                return _a.Unsafe.fromField(wrapped_js_1.Field.fromBits(bits));
            }
        },
        (() => {
...
let UInt32 = (() => {
    ...
    let _value_initializers = [];
    let _value_extraInitializers = [];
    return _a = class UInt32 extends _classSuper {
            /**
             ...
             */
            static MAXINT() {
                return new _a((1n << 32n) - 1n);
            }
            /**
             * Addition modulo 2^32. Check {@link Gadgets.addMod32} for a detailed description.
             */
            addMod32(y) {
                return new _a((0, arithmetic_js_1.addMod32)(this.value, y.value).value);
            }
            /**
             * Integer division with remainder.
             *
            ...
            divMod(y) {
                ...
                if (x.isConstant() && y_.isConstant()) {
                    ...
                    let r = xn - q * yn;
                    return {
                        quotient: new _a(new wrapped_js_1.Field(q.toString()).value),
                        rest: new _a(new wrapped_js_1.Field(r.toString()).value),
                    };
                }
                y_ = y_.seal();
                let q = provable_js_1.Provable.witness(wrapped_js_1.Field, () => new wrapped_js_1.Field(x.toBigInt() / y_.toBigInt()));
             ...
             */
            rotate(bits, direction = 'left') {
                return new _a(Bitwise.rotate32(this.value, bits, direction).value);
            }
            /**
             ...
             */
            leftShift(bits) {
                return new _a(Bitwise.leftShift32(this.value, bits).value);
            }
            /**
            ...
            lessThanOrEqual(y) {
                ...
                return (0, comparison_js_1.lessThanOrEqualGeneric)(this.value, y.value, 1n << 32n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
            ...
            lessThan(y) {
                ...
                return (0, comparison_js_1.lessThanGeneric)(this.value, y.value, 1n << 32n, (v) => RangeCheck.rangeCheckN(_a.NUM_BITS, v));
            }
            /**
...
let Sign = (() => {
    ...
    let _value_initializers = [];
    let _value_extraInitializers = [];
    return _a = class Sign extends _classSuper {
            static get one() {
                return new _a((0, wrapped_js_1.Field)(1));
            }
            static get minusOne() {
                return new _a((0, wrapped_js_1.Field)(-1));
            }
            ...
            static fromJSON(x) {
                return (x === 'Positive' ? new _a((0, wrapped_js_1.Field)(1)) : new _a((0, wrapped_js_1.Field)(-1)));
            }
            neg() {
                return new _a(this.value.neg());
            }
            mul(y) {
                return new _a(this.value.mul(y.value));
            }
            isPositive() {
            ...
            static fromValue(x) {
                if (x instanceof _a)
                    return x;
                return new _a((0, wrapped_js_1.Field)(x));
            }
            constructor() {
                super(...arguments);
                this.value = __runInitializers(this, _value_initializers, void 0); // +/- 1
                __runInitializers(this, _value_extraInitializers);
            }
        },
        (() => {
...
let Int64 = (() => {
    ...
    return _a = class Int64 extends _classSuper {
            ...
            constructor(magnitude, sgn = Sign.one) {
                ...
                this.magnitude = __runInitializers(this, _magnitude_initializers, void 0); // absolute value
                this.sgn = (__runInitializers(this, _magnitude_extraInitializers), __runInitializers(this, _sgn_initializers, void 0)); // +/- 1
            ...
            static create(magnitude, sign = Sign.one) {
                ...
                return new _a(mag, canonicalSign);
            }
            /**
            ...
            static fromFieldUnchecked(x) {
                ...
                return _a.create(UInt64.Unsafe.fromField(magnitude), sign);
            }
            ...
            static fromUnsigned(x) {
                return _a.create(x instanceof UInt32 ? x.toUInt64() : x);
            }
            // this checks the range if the argument is a constant
            /**
            ...
            static from(x) {
                ...
                if (x instanceof UInt64 || x instanceof UInt32) {
                    return _a.fromUnsigned(x);
                }
                return _a.fromFieldUnchecked((0, wrapped_js_1.Field)(x));
            }
            fromObject(obj) {
                return _a.create(UInt64.from(obj.magnitude), Sign.fromValue(obj.sgn));
            }
            /**
             ...
             */
            static get zero() {
                return _a.create(UInt64.zero);
            }
            /**
             * Static method to create a {@link Int64} with value `1`.
             */
            static get one() {
                return _a.create(UInt64.one);
            }
            /**
             * Static method to create a {@link Int64} with value `-1`.
             */
            static get minusOne() {
                return _a.create(UInt64.one).neg();
            }
            /**
            ...
            static fromField(x) {
                ...
                if (x.isConstant())
                    return _a.fromFieldUnchecked(x);
                // variable case - create a new checked witness and prove consistency with original field
                let xInt = provable_js_1.Provable.witness(_a, () => _a.fromFieldUnchecked(x));
             ...
             */
            neg() {
                return provable_js_1.Provable.if(this.magnitude.value.equals(0), _a.zero, new _a(this.magnitude, this.sgn.neg()));
            }
            /**
             * Addition with overflow checking.
             */
            add(y) {
                let y_ = _a.from(y);
                return _a.fromField(this.toField().add(y_.toField()));
            }
            /**
             * Subtraction with underflow checking.
             */
            sub(y) {
                let y_ = _a.from(y);
                return _a.fromField(this.toField().sub(y_.toField()));
            }
            /**
             * Multiplication with overflow checking.
             */
            mul(y) {
                let y_ = _a.from(y);
                return _a.fromField(this.toField().mul(y_.toField()));
            }
            /**
            ...
            div(y) {
                ...
                return _a.create(quotient, sign);
            }
            /**
            ...
            mod(y) {
                ...
                return new _a(new UInt64(rest.value));
            }
            /**
        ...
        _a.Unsafe = {
            fromObject(obj) {
                return circuit_value_js_1.CircuitValue.fromObject.call(_a, obj);
            },
        },
        _a;
})();
