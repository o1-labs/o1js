...
exports.StructNoJson = exports.HashInput = exports.circuitValueEquals = exports.cloneCircuitValue = exports.provableTuple = exports.Struct = void 0;
const wrapped_js_1 = require("../wrapped.js");
const provable_derivers_js_1 = require("./provable-derivers.js");
Object.defineProperty(exports, "provableTuple", { enumerable: true, get: function () { return provable_derivers_js_1.provableTuple; } });
Object.defineProperty(exports, "HashInput", { enumerable: true, get: function () { return provable_derivers_js_1.HashInput; } });
...
function Struct(type) {
    ...
    Struct_.type = (0, provable_derivers_js_1.provable)(type);
...
exports.StructNoJson = StructNoJson;
let primitives = new Set([wrapped_js_1.Field, wrapped_js_1.Bool, wrapped_js_1.Scalar, wrapped_js_1.Group]);
...
function cloneCircuitValue(obj) {
    ...
    if (obj instanceof proof_js_1.Proof || obj instanceof proof_js_1.DynamicProof) {
        return obj;
    }
...
exports.cloneCircuitValue = cloneCircuitValue;
function circuitValueEquals(a, b) {
    ...
    if ('equals' in a && typeof a.equals === 'function') {
        ...
        if (typeof isEqual === 'boolean')
            return isEqual;
        if (isEqual instanceof wrapped_js_1.Bool)
...
exports.circuitValueEquals = circuitValueEquals;
