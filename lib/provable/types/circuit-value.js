...
exports.arrayProp = exports.prop = exports.CircuitValue = void 0;
...
class CircuitValue {
    ...
    static toInput(v) {
        ...
        for (let i = 0, n = fields.length; i < n; ++i) {
            ...
            if ('toInput' in type) {
                input = provable_derivers_js_1.HashInput.append(input, type.toInput(v[key]));
                continue;
            }
    ...
    equals(x) {
        return provable_js_1.Provable.equal(this.constructor, this, x);
    }
    assertEquals(x) {
        provable_js_1.Provable.assertEqual(this, x);
    }
    isConstant() {
    ...
    static toCanonical(value) {
        ...
        fields.forEach(([key, type]) => {
            canonical[key] = provable_js_1.Provable.toCanonical(type, value[key]);
        });
        return canonical;
    }
    static toConstant(t) {
...
function arrayProp(elementType, length) {
    return function (target, key) {
        ...
        target._fields.push([key, provable_js_1.Provable.Array(elementType, length)]);
    };
}
